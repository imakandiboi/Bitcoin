<template>
  <div>
    <div class="bg-white">
      <section class="intro">
        <div class="h-full">
          <div class="mask d-flex align-items-center h-100" style="background-color: #fffff">
            <div class="container">
                        ...
                        <table class="table table-hover mb-0">
                          <thead>
                            <tr>
                              ...
                              <th scope="col">Asset Maturity <span class="text-lowercase" style="color: #c7c7c7">Per month </span></th>
                              <th scope="col">Next Payment Amt.</th>
                              <th scope="col">Investment Plan</th>
                              <th scope="col">Cat. of Investment</th>
                            </tr>
                          </thead>
                          <tbody>
                            <tr>
